...
object MicrosoftAuthService {
    ...
    val CLIENT_ID: String = System.getenv("MINELAB_AZURE_CLIENT_ID")
        ...
        ?: "08a1a647-a0a4-4e23-bcef-577fbbdb8265"
            ...
            server.createContext("/callback") { exchange ->
                try {
                    ...
                    if (isCompleted.compareAndSet(false, true)) {
                        safeCloseServer()
                        when {
                            code != null && receivedState == expectedState -> continuation.resume(code)
                            code != null -> continuation.resumeWithException(
                                ...
                                val userMessage = when (error) {
                                    ...
                                    "invalid_request" -> "Configuração inválida no registro do aplicativo Azure."
    ...
    private suspend fun exchangeAuthCodeForMicrosoftToken(
        clientId: String,
        code: String,
        codeVerifier: String
    ): String {
